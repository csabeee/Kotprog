...
export class Wrapper_Camera_project {
  context:import0.Camera_project;
  changed:boolean;
...
var renderType_Camera_project_Host:import2.RenderComponentType = (null as any);
class _View_Camera_project_Host0 extends import1.AppView<any> {
  _el_0:any;
  /*private*/ _appEl_0:import3.AppElement;
  _Camera_project_0_4:Wrapper_Camera_project;
  constructor(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import3.AppElement) {
    super(_View_Camera_project_Host0,renderType_Camera_project_Host,import6.ViewType.HOST,viewUtils,parentInjector,declarationEl,import7.ChangeDetectorStatus.CheckAlways);
  }
  createInternal(rootSelector:string):import3.AppElement {
    this._el_0 = this.selectOrCreateHostElement('ng-component',rootSelector,(null as any));
    this._appEl_0 = new import3.AppElement(0,(null as any),this,this._el_0);
    var compView_0:any = viewFactory_Camera_project0(this.viewUtils,this.injector(0),this._appEl_0);
    ...
    this._appEl_0.initComponent(this._Camera_project_0_4.context,([] as any[]),compView_0);
    compView_0.create(this._Camera_project_0_4.context,this.projectableNodes,(null as any));
    this.init(([] as any[]).concat([this._el_0]),[this._el_0],([] as any[]),([] as any[]));
    return this._appEl_0;
  }
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    if (((token === import0.Camera_project) && (0 === requestNodeIndex))) { return this._Camera_project_0_4.context; }
...
function viewFactory_Camera_project_Host0(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import3.AppElement):import1.AppView<any> {
  if ((renderType_Camera_project_Host === (null as any))) { (renderType_Camera_project_Host = viewUtils.createRenderComponentType('',0,import10.ViewEncapsulation.None,([] as any[]),{})); }
  return new _View_Camera_project_Host0(viewUtils,parentInjector,declarationEl);
}
export const Camera_projectNgFactory:import11.ComponentFactory<import0.Camera_project> = new import11.ComponentFactory<import0.Camera_project>('ng-component',viewFactory_Camera_project_Host0,import0.Camera_project);
const styles_Camera_project:any[] = ([] as any[]);
var renderType_Camera_project:import2.RenderComponentType = (null as any);
class _View_Camera_project0 extends import1.AppView<import0.Camera_project> {
  _el_0:any;
  ...
  createInternal(rootSelector:string):import3.AppElement {
    ...
    this._Navbar_2_4 = new import13.Wrapper_Navbar(this.parentInjector.get(import24.App),this.parentInjector.get(import23.ViewController,(null as any)),this.parentInjector.get(import25.NavController,(null as any)),this.parentInjector.get(import21.Config),new import22.ElementRef(this._el_2),this.renderer);
    ...
    this._MenuToggle_4_5 = new import15.Wrapper_MenuToggle(this.parentInjector.get(import26.MenuController),new import22.ElementRef(this._el_4),this.parentInjector.get(import23.ViewController,(null as any)),this._Navbar_2_4.context);
    this._ToolbarItem_4_6 = new import16.Wrapper_ToolbarItem(this.parentInjector.get(import21.Config),new import22.ElementRef(this._el_4),this.renderer,this.parentInjector.get(import27.Toolbar,(null as any)),this._Navbar_2_4.context);
    ...
    this._ToolbarTitle_9_4 = new import19.Wrapper_ToolbarTitle(this.parentInjector.get(import21.Config),new import22.ElementRef(this._el_9),this.renderer,this.parentInjector.get(import27.Toolbar,(null as any)),this._Navbar_2_4.context);
    this._appEl_9.initComponent(this._ToolbarTitle_9_4.context,([] as any[]),compView_9);
    this._text_10 = this.renderer.createText((null as any),'Kamera_projekt',(null as any));
    ...
    this._text_17 = this.renderer.createText(this._el_16,'Ez egy kamerás app',(null as any));
...
export function viewFactory_Camera_project0(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import3.AppElement):import1.AppView<import0.Camera_project> {
  if ((renderType_Camera_project === (null as any))) { (renderType_Camera_project = viewUtils.createRenderComponentType('',0,import10.ViewEncapsulation.None,styles_Camera_project,{})); }
