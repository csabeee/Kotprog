...
import * as import55 from '../pages/Camera_project/Camera_project.ngfactory';
...
import * as import62 from './app.component';
import * as import63 from '@angular/common/src/location/platform_location';
import * as import64 from '@angular/common/src/location/location_strategy';
...
import * as import67 from 'ionic-angular/platform/query-params';
...
class AppModuleInjector extends import0.NgModuleInjector<import1.AppModule> {
  ...
  constructor(parent:import45.Injector) {
    super(parent,[
      ...
      import54.MyAppNgFactory,
      import55.Camera_projectNgFactory,
      import48.IonicAppNgFactory
    ]
    ,[import48.IonicAppNgFactory]);
  }
  ...
  get _APP_ID_29():any {
    if ((this.__APP_ID_29 == (null as any))) { (this.__APP_ID_29 = import56._appIdRandomProviderFactory()); }
  ...
  get _EVENT_MANAGER_PLUGINS_32():any[] {
    if ((this.__EVENT_MANAGER_PLUGINS_32 == (null as any))) { (this.__EVENT_MANAGER_PLUGINS_32 = [
      ...
      new import59.HammerGesturesPlugin(this._HAMMER_GESTURE_CONFIG_31)
    ]
    ); }
    return this.__EVENT_MANAGER_PLUGINS_32;
  }
  get _EventManager_33():import16.EventManager {
    if ((this.__EventManager_33 == (null as any))) { (this.__EventManager_33 = new import16.EventManager(this._EVENT_MANAGER_PLUGINS_32,this.parent.get(import60.NgZone))); }
  ...
  get _RootRenderer_37():any {
    if ((this.__RootRenderer_37 == (null as any))) { (this.__RootRenderer_37 = import61._createConditionalRootRenderer(this._DomRootRenderer_36,this.parent.get(import61.NgProbeToken,(null as any)))); }
  ...
  get _AppRootToken_53():any {
    if ((this.__AppRootToken_53 == (null as any))) { (this.__AppRootToken_53 = import62.MyApp); }
  ...
  get _Keyboard_61():import34.Keyboard {
    if ((this.__Keyboard_61 == (null as any))) { (this.__Keyboard_61 = new import34.Keyboard(this._Config_21,this._Form_58,this.parent.get(import60.NgZone))); }
  ...
  get _LocationStrategy_63():any {
    if ((this.__LocationStrategy_63 == (null as any))) { (this.__LocationStrategy_63 = import8.provideLocationStrategy(this.parent.get(import63.PlatformLocation),this.parent.get(import64.APP_BASE_HREF,(null as any)),this._Config_21)); }
  ...
  get _TapClick_69():import41.TapClick {
    if ((this.__TapClick_69 == (null as any))) { (this.__TapClick_69 = new import41.TapClick(this._Config_21,this._App_22,this.parent.get(import60.NgZone))); }
  ...
  get _UrlSerializer_73():any {
    if ((this.__UrlSerializer_73 == (null as any))) { (this.__UrlSerializer_73 = import65.setupUrlSerializer(this._DeepLinkConfigToken_54)); }
    return this.__UrlSerializer_73;
  }
  get _DeepLinker_74():any {
    if ((this.__DeepLinker_74 == (null as any))) { (this.__DeepLinker_74 = import66.setupDeepLinker(this._App_22,this._UrlSerializer_73,this._Location_64)); }
  ...
  createInternal():import1.AppModule {
    ...
    this._QueryParams_14 = import67.setupQueryParams(this._UrlToken_13);
    this._PlatformConfigToken_15 = import68.providePlatformConfigs();
    ...
    this._Platform_20 = import69.setupPlatform(this._PlatformConfigToken_15,this._QueryParams_14,this._UserAgentToken_16,this._NavigatorPlatformToken_17,this._DocumentDirToken_18,this._DocLangToken_19,this.parent.get(import60.NgZone));
    this._Config_21 = import70.setupConfig(this._ConfigToken_12,this._QueryParams_14,this._Platform_20);
    this._App_22 = new import10.App(this._Config_21,this._Platform_20);
    this._APP_INITIALIZER_23 = [
      import71.registerModeConfigs(this._Config_21),
      import72.registerTransitions(this._Config_21),
      import30.setupProvideEvents(this._Platform_20),
      import41.setupTapClick(this._Config_21,this._App_22,this.parent.get(import60.NgZone))
    ]
    ;
    this._ApplicationInitStatus_24 = new import11.ApplicationInitStatus(this._APP_INITIALIZER_23);
    this._Testability_25 = new import12.Testability(this.parent.get(import60.NgZone));
    this._ApplicationRef__26 = new import13.ApplicationRef_(this.parent.get(import60.NgZone),this.parent.get(import73.Console),this,this._ErrorHandler_11,this,this._ApplicationInitStatus_24,this.parent.get(import12.TestabilityRegistry,(null as any)),this._Testability_25);
  ...
  getInternal(token:any,notFoundResult:any):any {
    ...
    if ((token === import74.LOCALE_ID)) { return this._LOCALE_ID_9; }
    if ((token === import9.NgLocalization)) { return this._NgLocalization_10; }
    if ((token === import75.ErrorHandler)) { return this._ErrorHandler_11; }
    if ((token === import70.ConfigToken)) { return this._ConfigToken_12; }
    if ((token === import67.UrlToken)) { return this._UrlToken_13; }
    if ((token === import67.QueryParams)) { return this._QueryParams_14; }
    if ((token === import68.PlatformConfigToken)) { return this._PlatformConfigToken_15; }
    if ((token === import69.UserAgentToken)) { return this._UserAgentToken_16; }
    if ((token === import69.NavigatorPlatformToken)) { return this._NavigatorPlatformToken_17; }
    if ((token === import69.DocumentDirToken)) { return this._DocumentDirToken_18; }
    if ((token === import69.DocLangToken)) { return this._DocLangToken_19; }
    if ((token === import69.Platform)) { return this._Platform_20; }
    if ((token === import70.Config)) { return this._Config_21; }
    ...
    if ((token === import56.APP_ID)) { return this._APP_ID_29; }
    if ((token === import76.DOCUMENT)) { return this._DOCUMENT_30; }
    if ((token === import59.HAMMER_GESTURE_CONFIG)) { return this._HAMMER_GESTURE_CONFIG_31; }
    ...
    if ((token === import77.AnimationDriver)) { return this._AnimationDriver_35; }
    if ((token === import18.DomRootRenderer)) { return this._DomRootRenderer_36; }
    if ((token === import78.RootRenderer)) { return this._RootRenderer_37; }
    if ((token === import19.DomSanitizer)) { return this._DomSanitizer_38; }
    if ((token === import79.Sanitizer)) { return this._Sanitizer_39; }
    if ((token === import20.ViewUtils)) { return this._ViewUtils_40; }
    if ((token === import80.IterableDiffers)) { return this._IterableDiffers_41; }
    if ((token === import81.KeyValueDiffers)) { return this._KeyValueDiffers_42; }
    ...
    if ((token === import84.AppRootToken)) { return this._AppRootToken_53; }
    if ((token === import65.DeepLinkConfigToken)) { return this._DeepLinkConfigToken_54; }
    ...
    if ((token === import64.LocationStrategy)) { return this._LocationStrategy_63; }
    ...
    if ((token === import65.UrlSerializer)) { return this._UrlSerializer_73; }
    if ((token === import66.DeepLinker)) { return this._DeepLinker_74; }
